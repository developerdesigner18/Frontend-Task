...
import { Mail, Lock, User, Eye, EyeOff, Loader2, ArrowRight, UserPlus } from 'lucide-react'
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_LARAVEL_API_URL || 'http://localhost:8000'}/api/register`,
                {
                    method: 'POST',
                    headers: {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-blue-300 to-blue-500 rounded-full opacity-5 animate-pulse delay-500"></div>
            </div>
